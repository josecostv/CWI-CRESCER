...
@Service
public class BuscarPublicacoesUsuarioService {
    ...
    public Page<PublicacaoResponse> buscar(Long id, Pageable pageable) {

        usuarioService.existePorId(id);

        return publicacaoRepository.findByUsuarioIdOrderByDataPublicacaoDesc(id, pageable)
